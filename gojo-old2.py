...
def num():
    ...
    with ThreadPool(max_workers=30) as noob:
        ...
        #s.system('espeak -a 200 "Random cloning Started AXN Mahmud"')
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print(f"\033[38;5;46m[GS-OK❤️] {uid} | {ps}")
            ...
            #    print(f"\x1b[38;5;196m[GS-CP❎] {uid}|{ps}Ua = \033[1;34m'+pro+'  \033[0;97m")
